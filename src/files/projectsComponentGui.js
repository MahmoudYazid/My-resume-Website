        ...
        return(
            <div class="relative min-w-[13rem] h-80 bg-gray-50 rounded-2xl p-4  shadow shadow-sky-800 flex flex-col justify-around items-stretch">
                ...
                <div class="flex flex-col gap-2">
                    <button class="border-2 border-blue-400 bg-blue-400 py-1 rounded text-gray-50 hover:bg-blue-300">Link</button>
                    <button class="border-2 border-blue-400 py-1 rounded hover:bg-gray-100">Github</button>
                </div>
